...
import { BookOpen, Search, Folder, Clock, Moon, Sun, Settings, Sparkles, Globe, LogOut, Shield, Users, Keyboard, Scale, Network } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <nav id="tour-sidebar" className="flex-1 flex flex-col items-center py-4 gap-3 md:gap-2">
        ...
        {/* Slice 4 Decision A: /grafo is the Q&A surface; the hub stays at /merlt.
            Plain flag functions (not useMerltFeatures) keep the Sidebar free of
            the consent/auth providers. */}
