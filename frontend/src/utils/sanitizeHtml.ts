/**
 * HTML sanitization helpers using DOMPurify to prevent XSS attacks.
 *
 * Pure (non-component) utilities — kept separate from the `SafeHTML` component
 * in `sanitize.tsx` so the component file can satisfy
